...
작업 시작 카드 · 레퍼런싱 · 제품 지도(명세+IA) · 지도 드리프트 점검 · 계획 검증 게이트 · 모델 라우팅 · 실제 구동 검증 · 디자인 정합성 · 코드 검증 게이트 · 끝 점검 · 정성 채점(끝 점검 별점) · 비전문가 요약 · 멈춤 규칙 · 개인화 메모리 · 언어 적응형 · 약속-미실행 가드 · 최소 구현 우선 · 검수·git 안전 · 검증 체크리스트 등뼈 · 정기 자동 점검 · 보안 스캔 · 디자인 검증 사슬
</details>
