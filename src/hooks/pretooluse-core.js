...
const REASONS = {
  "plan-size":
    ...
    "(3,700 초과 예: `my-plan.md는 5,200줄로 알려진 사례 밖입니다 — 쪼개기를 먼저 권합니다. " +
...
//     — 인용한 분석 문서에 그 수치가 없고 손으로 센 것이었다. 이 가드가 얼마나 귀찮게 하는지를
//     말하려면 새로 재라. 위 5건은 "지금 크다"일 뿐 "가드를 만났을 것"이 아니다(넘긴 뒤 게이트를
//     다시 받았는지는 안 셌다).
