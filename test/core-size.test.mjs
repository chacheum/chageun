...
// 2026-08-08 +1677 (18136 → 19813): **출력 스타일 절 신설**(v0.51.0) +1707, `:3` 머리말 설명 −30.
...
//
// 기존 커버리지(실측): 코어 본문을 앵커하는 테스트는 4개다 — rules-labels(SECTION_LABELS 13 +
...
// SECTION_LABELS 13개 중 `게이트 판정 ↔ 멈춤`은 하위 절이고, `# Finish check` 절은 HOOK_SEEDS의
