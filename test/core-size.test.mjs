...
// 다른 후보를 찾다가 실제 중복 1건은 걷어냈다(−64B): 새로 쓴 "라벨을 그대로 써라" 문장이 `:9`의
// "Summary fields, all five exactly … verbatim"과 같은 말이라 `:9`를 가리키는 한 조각으로 줄였다.
// 그 외에는 안전 캡슐(`:138`)처럼 **일부러 둔 중복**뿐이라 손대지 않았다.
