...
const REASONS = {
  "plan-size":
    ...
    "(6) 질문 본문에 **잰 파일 이름과 실제 줄 수, 3,700과 비교한 결과**를 한 줄로 적으세요 " +
    "(예: `my-plan.md는 3,200줄입니다 — 이 구간엔 잘 끝난 계획도 있습니다`). " +
    "이 차단문은 사용자가 아니라 당신이 읽습니다 — 안 적으면 사용자 화면엔 승인 키의 천 단위 " +
    "버킷(`3k`)만 남아, 자기 계획이 몇 줄인지 모르는 채 승인하게 됩니다.\n" +
