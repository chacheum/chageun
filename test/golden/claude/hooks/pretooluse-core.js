...
//   (1) 회차의 **주체를 정하는 규칙이 이미 blocker 로 두 번 실패했다** — 참고로 언급한 옛 계획서가
//       기준이 되어 처음 검증받는 계획을 막는 경로를 못 없앴다. 이게 기각의 본체다.
//   (2) 문턱 근거가 약하다 — 실측 218개 트랜스크립트·83세션 분포에서 늦은 회차 표본이 한 자릿수라
//       어디에 걸어도 표본 몇 개에 맞춘 값이 된다.
